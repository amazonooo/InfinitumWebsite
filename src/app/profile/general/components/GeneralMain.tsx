				...
				>
					<div className='p-6'>
						...
						<div className='flex justify-center items-center md:flex-row flex-col gap-8 mt-12'>
							<div className='rounded-lg border border-neutral-400 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] bg-[#09090B]'>
							...
							<div className='rounded-lg border border-neutral-400 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] bg-[#09090B] min-h-[180px]'>
								<div className='p-5 text-center'>
									<div className='flex flex-col items-center'>

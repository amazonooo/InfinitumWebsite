...
export function SidebarDemo() {
	...
	return (
		<div
			className={cn(
				'rounded-lg flex fixed lg:top-1/4 bottom-[78.7px] right-5 sm:right-9 z-[500] lg:right-0 flex-col md:flex-row dark:bg-neutral-900 flex-1 border border-[#cbacf9]/20 overflow-hidden w-fit h-fit'
			)}
		>

				...
				>
					<div className='flex flex-row gap-36'>
						<div className='flex items-center justify-center'>
							<form className='relative rounded-xl border border-white/[0.2] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] bg-[#09090B] p-8 sm:p-9 md:p-10 w-[320px] sm:w-[400px] md:w-[500px] lg:w-[600px]'>
								...
								<h2 className='text-3xl md:text-4xl font-bold text-center mb-8 Welcome-text'>
									{type}
								</h2>
								<div className='text-center'>
									...
									<div className='mb-3' onClick={handleClick('account')}>
										<MainButton className='uppercase px-5 py-2'>
											{type}
										</MainButton>
									</div>
									{type === 'Войти' ? (

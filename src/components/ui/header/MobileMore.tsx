			...
			<div className='p-7 flex flex-col'>
				<div className='flex justify-between items-center mb-24'>
					...
					>
						...
						<div
							ref={dropdownRef}
							className={`absolute right-0 top-[2.35rem] border border-[#cbacf9]/20 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] bg-[#09090B] flex flex-col justify-between rounded-lg text-base w-52 opacity-0 transition-opacity duration-300 ${
